...
public class ValidationUtil {
	 ...
	 * @throws br.com.geraldoferraz.scanyourpath.util.EmptyStringException
	 *             if the parameter is null
	 */
	 ...
	 * 
	 * @param objects
	 *            the set of parameters to be checked
	 * @throws IllegalArgumentException
	 *             if any of the parameteres is null
	 */
	 ...
	 * @throws br.com.geraldoferraz.scanyourpath.util.EmptyArrayException
